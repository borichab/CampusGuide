...
public abstract class ConnectionsActivity extends AppCompatActivity {
  ...
  //The devices discovered near individual's device.
  private final Map<String, Endpoint> mDiscoveredEndpoints = new HashMap<>();

  //The devices pending for connections until it get connected.
  private final Map<String, Endpoint> mPendingConnections = new HashMap<>();

  //The devices are currently connected.
  private final Map<String, Endpoint> mEstablishedConnections = new HashMap<>();

  //True if we are asking a discovered device to connect to us
  private boolean mIsConnecting = false;

  //True if device is discovering.
  private boolean mIsDiscovering = false;

  //True if device is advertising.
      ...
      new ConnectionLifecycleCallback() {
        ...
        public void onDisconnected(String endpointId) {
          if (!mEstablishedConnections.containsKey(endpointId)) {
            Toast.makeText(ConnectionsActivity.this, "Unexpected disconnection from Device : " + endpointId, Toast.LENGTH_SHORT).show();
  ...
  //Called when Activity has been made visible to the user.
  @Override
  ...
  //Sets the device to advertising mode.
  ...
  //Returns true if device currently attempting to connect to another device.
  ...
  //alled when someone has connected to us. Override this method to act on the event.
